      ...
      >
        ...
        <Card className="w-full rounded-2xl border-border/60 bg-card/60 backdrop-blur-2xl shadow-2xl">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription className="text-xs font-medium text-muted-foreground">Sign in to your client workspace</CardDescription>
          </CardHeader>
          <CardContent className="p-6">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-wider">
                <span className="bg-card/90 px-3 text-muted-foreground">Or email login</span>
              </div>
            </div>
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-xs font-semibold text-primary hover:text-cyan-400 transition-colors"
                  >
                    Forgot password?
                  </Link>
                </div>
            ...
            <p className="mt-5 text-center text-xs text-muted-foreground font-medium">
              ...
              <Link href="/auth/register" className="font-bold text-primary hover:text-cyan-400 transition-colors">
                Create one now
              </Link>
            </p>
          </CardContent>
