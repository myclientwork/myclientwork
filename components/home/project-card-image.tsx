...
export function ProjectCardImage({ project }: ProjectCardImageProps) {
  ...
  return (
    <div className="relative aspect-video overflow-hidden bg-muted">
      ...
      <div className="absolute top-3 right-3 rounded-full bg-slate-950/70 p-2 backdrop-blur-md text-white opacity-0 transition-opacity group-hover:opacity-100">
